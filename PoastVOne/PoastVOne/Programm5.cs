      ...
      public  static void SolveFx(Parameter5 parameter5)   // the main logic method that is repeated above
        {
            ...
            parameter5.upperFx = Math.Pow(parameter5.upperx, 2) - (2 * (parameter5.upperx * parameter5.y)) + 2 * Math.Pow(parameter5.y, 2) + (8 * parameter5.upperx) + (3 * parameter5.y);
            parameter5.lowerx = parameter5.x - parameter5.h1;
            parameter5.lowerFx = Math.Pow(parameter5.lowerx, 2) - (2 * (parameter5.lowerx * parameter5.y)) + 2 * Math.Pow(parameter5.y, 2) + (8 * parameter5.lowerx) + (3 * parameter5.y);
            ...
            if (parameter5.upperFx <= parameter5.lowerFx)
            {
                ...
                parameter5.upperFy = Math.Pow(parameter5.xF, 2) - (2 * (parameter5.xF * parameter5.uppery)) + 2 * Math.Pow(parameter5.uppery, 2) + (8 * parameter5.xF) + (3 * parameter5.uppery);
                parameter5.lowery = parameter5.y - parameter5.h1;
                parameter5.lowerFy = Math.Pow(parameter5.xF, 2) - (2 * (parameter5.xF * parameter5.lowery)) + 2 * Math.Pow(parameter5.lowery, 2) + (8 * parameter5.xF) + (3 * parameter5.lowery);
            ...
            if (parameter5.bestPoint == parameter5.upperFx)
            {
                ...
                parameter5.THf = Math.Pow(parameter5.THxx, 2) - (2 * (parameter5.THxx * parameter5.THyy)) + 2 * Math.Pow(parameter5.THyy, 2) + (8 * parameter5.THxx) + (3 * parameter5.THyy);
