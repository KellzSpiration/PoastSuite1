...
namespace PoastVOne
{
  public  class Parameter
    {
        public Parameter(double _x, double _xF, double _y, double _THx, double _THy, double _THf, double _uppery, double _upperx, double _lowery, double _lowerx, double _h1, double _h2, double _lowerFx, double _lowerFy, double _upperFx, double _upperFy, double _bestPoint, double _h1F, double _h2F, double _f, int _i)
        {
            x = _x;
            xF = _xF;
            y = _y;
