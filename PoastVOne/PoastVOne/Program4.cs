      ...
      public  static void SolveFx(Parameter4 parameter4)   // the main logic method that is repeated above
        {
            ...
            parameter4.upperFx = 6 * Math.Pow(parameter4.upperx, 2) - (5 * (parameter4.upperx * parameter4.y)) + 2 * Math.Pow(parameter4.y, 2) + (4 * parameter4.upperx) + (2 * parameter4.y);
            parameter4.lowerx = parameter4.x - parameter4.h1;
            parameter4.lowerFx = 6 * Math.Pow(parameter4.lowerx, 2) - (5 * (parameter4.lowerx * parameter4.y)) + 2 * Math.Pow(parameter4.y, 2) + (4 * parameter4.lowerx) + (2 * parameter4.y);
            ...
            if (parameter4.upperFx <= parameter4.lowerFx)
            {
                ...
                parameter4.upperFy = 6 * Math.Pow(parameter4.xF, 2) - (5 * (parameter4.xF * parameter4.uppery)) + 2 * Math.Pow(parameter4.uppery, 2) + (4 * parameter4.xF) + (2 * parameter4.uppery);
                parameter4.lowery = parameter4.y - parameter4.h1;
                parameter4.lowerFy = 6 * Math.Pow(parameter4.xF, 2) - (5 * (parameter4.xF * parameter4.lowery)) + 2 * Math.Pow(parameter4.lowery, 2) + (4 * parameter4.xF) + (2 * parameter4.lowery);
            ...
            if (parameter4.bestPoint == parameter4.upperFx)
            {
                ...
                parameter4.THf = 6 * Math.Pow(parameter4.THxx, 2) - (5 * (parameter4.THxx * parameter4.THyy)) + 2 * Math.Pow(parameter4.THyy, 2) + (4 * parameter4.THxx) + (2 * parameter4.THyy);
