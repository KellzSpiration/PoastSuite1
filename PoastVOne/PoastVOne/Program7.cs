      ...
      public  static void SolveFx(Parameter7 parameter7)   // the main logic method that is repeated above
        {
            ...
            parameter7.upperFx = 6 * Math.Pow(parameter7.upperx, 2) - (9 * (parameter7.upperx * parameter7.y)) + 4 * Math.Pow(parameter7.y, 2) + (2 * parameter7.upperx) + (2 * parameter7.y);
            parameter7.lowerx = parameter7.x - parameter7.h1;
            parameter7.lowerFx = 6 * Math.Pow(parameter7.lowerx, 2) - (9 * (parameter7.lowerx * parameter7.y)) + 4 * Math.Pow(parameter7.y, 2) + (2 * parameter7.lowerx) + (2 * parameter7.y);
            ...
            if (parameter7.upperFx <= parameter7.lowerFx)
            {
                ...
                parameter7.upperFy = 6 * Math.Pow(parameter7.xF, 2) - (9 * (parameter7.xF * parameter7.uppery)) + 4 * Math.Pow(parameter7.uppery, 2) + (2 * parameter7.xF) + (2 * parameter7.uppery);
                parameter7.lowery = parameter7.y - parameter7.h1;
                parameter7.lowerFy = 6 * Math.Pow(parameter7.xF, 2) - (9 * (parameter7.xF * parameter7.lowery)) + 4 * Math.Pow(parameter7.lowery, 2) + (2 * parameter7.xF) + (2 * parameter7.lowery);
            ...
            if (parameter7.bestPoint == parameter7.upperFx)
            {
                ...
                parameter7.THf = 6 * Math.Pow(parameter7.THxx, 2) - (9 * (parameter7.THxx * parameter7.THyy)) + 4 * Math.Pow(parameter7.THyy, 2) + (2 * parameter7.THxx) + (2 * parameter7.THyy);
