      ...
      public  static void SolveFx(Parameter6 parameter6)   // the main logic method that is repeated above
        {
            ...
            parameter6.upperFx = 9 * Math.Pow(parameter6.upperx, 2) - (2 * (parameter6.upperx * parameter6.y)) + 6 * Math.Pow(parameter6.y, 2) + (parameter6.upperx) + (2 * parameter6.y);
            parameter6.lowerx = parameter6.x - parameter6.h1;
            parameter6.lowerFx = 9 * Math.Pow(parameter6.lowerx, 2) - (2 * (parameter6.lowerx * parameter6.y)) + 6 * Math.Pow(parameter6.y, 2) + (parameter6.lowerx) + (2 * parameter6.y);
            ...
            if (parameter6.upperFx <= parameter6.lowerFx)
            {
                ...
                parameter6.upperFy = 9 * Math.Pow(parameter6.xF, 2) - (2 * (parameter6.xF * parameter6.uppery)) + 6 * Math.Pow(parameter6.uppery, 2) + (parameter6.xF) + (2 * parameter6.uppery);
                parameter6.lowery = parameter6.y - parameter6.h1;
                parameter6.lowerFy = 9 * Math.Pow(parameter6.xF, 2) - (2 * (parameter6.xF * parameter6.lowery)) + 6 * Math.Pow(parameter6.lowery, 2) + (parameter6.xF) + (2 * parameter6.lowery);
            ...
            if (parameter6.bestPoint == parameter6.upperFx)
            {
                ...
                parameter6.THf = 9 * Math.Pow(parameter6.THxx, 2) - (2 * (parameter6.THxx * parameter6.THyy)) + 6 * Math.Pow(parameter6.THyy, 2) + (parameter6.THxx) + (2 * parameter6.THyy);
